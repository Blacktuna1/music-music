      ...
      <div class="left">
        <div class="avatar" @click="$store.commit('changeMusicDetailCardState')">
          <img
            ...
            :draggable="false"
          />
          <img src="" alt="" v-else :draggable="false" />
        </div>
        <div class="musicInfo">
      ...
      <div class="center">
        <div class="buttons">
          ...
          <span @click="musicList.length != 0 ? changePlayState() : ''">
            ...
            ></i>
            <i class="iconfont icon-zanting_o" v-else></i>
          </span>
...
//   粤ICP备2021068014号<br>个人邮箱: 63012138@qq.com<br>本站为仿网易云音乐展示项目, 仅供学习使用, 侵权必删!</div>`,
    ...
    //created函数在初始化页面时就会执行，也就是说，初始化时，用户信息就被载入
    //这样可以做到保留登录信息
    async created() {
        // this.getHotSearch();
